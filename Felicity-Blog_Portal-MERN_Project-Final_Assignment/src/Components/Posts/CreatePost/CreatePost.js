...
export class CreatePost extends Component {
    constructor(props) {
        ...
        this.state = {
            Post: {
                id: '',
                title: '',
                category: POST_CATEGORIES.ALL_CATEGORIES,
                content: '',
                imagePath: '',
                created: ''
            },
    ...
    componentDidMount() {
        ...
        if (path === "/edit/:id") {
            ...
            Axios.get("/posts/" + id).then(data => {
                ...
                this.setState({
                    isloading: false,
                    Post: { ...this.state.Post, id: post._id, title: post.title, category: post.category, content: post.content, imagePath: post.imagePath }
                });
            })
                .catch(e => {
                    console.log(e)
    ...
    myChangeHandler = (event) => {
        ...
        switch (name) {
            ...
            case 'category':
                // if (!Object.values(POST_CATEGORIES).indexOf(value) > -1) {
                //     errors.category = 'Invalid Category Passed';
                // }
                if (value.length === 0) {
                    errors.category =
                        value.length === 0
    ...
    mySubmitHandler(e) {
        ...
        if (typeof (this.state.Post.imagePath) === "object") {
            ...
            formData.append('category', this.state.Post.category);
                ...
                <form onSubmit={this.mySubmitHandler} className="pt-4">
                    ...
                    <div className="form-group">
                        ...
                        <input
                            ...
                            className={"form-control " + (this.state.errors.category ? 'is-invalid' : '')}
                        ...
                        {this.state.errors.category.length > 0 &&
                            <div className="mt-1"><span className='error text-danger'>{this.state.errors.category}</span></div>}
